...
export function ComponentShowcase() {
  return (
    <section className="flex w-full flex-col gap-10 pt-24 pb-32 sm:pt-28 sm:pb-24">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          ...
          <CardContent className="grid gap-4 sm:grid-cols-2">
            ...
            <ScrollArea className="h-28 rounded-surface border">
        ...
        <Card className="md:col-span-2">
          ...
          <CardContent>
            <Command className="max-w-sm rounded-surface border">
              <KeepPageScroll />
